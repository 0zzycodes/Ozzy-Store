...
const ResellerPage = () => {
  return (
    <div className="reseller-page">
      <h3>Ozzy Reseller Plan</h3>
      <div className="block">
        <h4>What Is The Ozzy Reseller Plan?</h4>
        <p>
          It is with profound pleasure that we welcome your decision to become a
          registered Reseller for Ozzy products. Ours is a fashion brand a lot
          ...
          fastest growing fashion brands, Ozzy is focused on mainstreaming tried
          and tested business practices as the Company strives to deliver
          sustainable economic growth that’s profitable, environmentally
          responsible and socially relevant.
        </p>
      </div>
      <div className="block">
        <h4>What Are the Benefits Of Joining The Ozzy Reseller Plan?</h4>
        <ul>
      ...
      <div className="block">
        ...
        <p>
          you may send an email to order@ozzy.store, or contact us via phone
